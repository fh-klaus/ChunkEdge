...
ChunkEdge users can choose not to include `chunkedge_network` in their project. This could be useful for testing or using ChunkEdge as an integrated server in a client.
